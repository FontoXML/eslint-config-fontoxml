module.exports = {
	// @TODO: Check if only rules are included which do not depend on type information.
	rules: {
		...
		'@typescript-eslint/prefer-readonly-parameter-types': 'off', // Not sure...
		...
		'@typescript-eslint/typedef': [
			'error',
			{ parameter: false, arrowParameter: false, variableDeclaration: false }
		],
